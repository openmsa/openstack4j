...
/**
 * Allows for interception during the creation of a new HttpClient. To register
 * a custom singleton interceptor you must invoke
...
public interface HttpClientConfigInterceptor {
	...
	/**
	 * This method is invoked prior to the HttpClientBuilder build is called
