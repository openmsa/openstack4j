...
import org.openstack4j.openstack.telemetry.builder.GnocchiBuilderImpl;
...
public class Builders {
     ...
     * @deprecated @deprecated Since these APIs are only implemented for
     *             nova-network, they are deprecated. These will fail with a 404
     *             starting from microversion 2.36. They were removed in the 18.0.0
     *             Rocky release.
     */
    @Deprecated
    ...
    public static GnocchiBuilder gnocchi() {
        return new GnocchiBuilderImpl();
    }
}
