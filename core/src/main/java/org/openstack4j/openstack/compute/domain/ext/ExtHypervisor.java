...
public class ExtHypervisor implements Hypervisor {
    ...
    static class HypervisorService implements Service {
        ...
        @Override
        public String toString() {
            return new ToStringHelper(this).add("id", id).add("host", host).toString();
        }
    }
    ...
    static class HypervisorCPUInfo implements CPUInfo {
        ...
        @Override
        public String toString() {
            return new ToStringHelper(this).add("vendor", vendor)
                    .add("model", model)
                    .add("arch", arch)
    ...
    static class HypervisorCPUTopology implements CPUTopology {
        ...
        @Override
        public String toString() {
            return new ToStringHelper(this).add("cores", cores)
                    .add("threads", threads)
                    .add("sockets", sockets)
                    .toString();
        }
