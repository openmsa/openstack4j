...
import org.openstack4j.openstack.networking.internal.NeutronResourceTagServiceImpl;
...
import org.openstack4j.openstack.networking.internal.ext.NetQosPolicyServiceImpl;
...
import org.openstack4j.openstack.networking.internal.ext.PortForwardingServiceImpl;
...
import org.openstack4j.openstack.telemetry.internal.gnocchi.GnocchiServiceImpl;
import org.openstack4j.openstack.telemetry.internal.gnocchi.MeasuresServiceImpl;
import org.openstack4j.openstack.telemetry.internal.gnocchi.MetricsServiceImpl;
import org.openstack4j.openstack.telemetry.internal.gnocchi.SearchServiceImpl;
...
public class DefaultAPIProvider implements APIProvider {
    ...
    public void initialize() {
        ...
        bind(MetricsService.class, MetricsServiceImpl.class);
        bind(GnocchiService.class, GnocchiServiceImpl.class);
        bind(org.openstack4j.api.telemetry.gnocchi.ResourcesService.class,
                org.openstack4j.openstack.telemetry.internal.gnocchi.ResourcesServiceImpl.class);
        bind(SearchService.class, SearchServiceImpl.class);
        bind(MeterService.class, MeterServiceImpl.class);
        bind(MeasuresService.class, MeasuresServiceImpl.class);
    ...
    public <T> T get(final Class<T> api) {
        ...
        if (bindings.containsKey(api)) {
            try {
                final T impl = (T) bindings.get(api).newInstance();
    ...
    private void bind(final Class<?> api, final Class<?> impl) {
